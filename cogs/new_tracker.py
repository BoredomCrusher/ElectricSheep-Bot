...
#                     data[user_id]["read"] = math.floor(data[user_id]["read"] / 2)
#                 else:
#                     data[user_id]["read"] += 1
#                 if user_id not in set(meta["two days ago's writers"]):
#                     data[user_id]["write"] = math.floor(data[user_id]["write"] / 2)
#                 else:
...
#             leaderboard_msg = await self.channel.send(self.make_leaderboard(sorted_by_read, 
#                                                                             sorted_by_write, 
...
#             updated_leaderboard = self.make_leaderboard(sorted_by_read, 
#                                                         sorted_by_write, 
#                                                         read_lines, 
#                                                         write_lines)
#             try:
